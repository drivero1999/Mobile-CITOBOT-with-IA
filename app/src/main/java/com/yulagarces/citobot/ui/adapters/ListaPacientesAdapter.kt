...
import com.yulagarces.citobot.ui.adapters.ListaPacientesAdapter.PacienteViewHolder
...
class ListaPacientesAdapter(var listaPacientes: ArrayList<Patient>) :
    ...
    override fun onBindViewHolder(holder: PacienteViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            navController.navigate(R.id.action_nav_consultar_paciente_to_nav_tamizaje_paso1)
            ...
            editor.apply()
            sessionManager.savePatientName(listaPacientes[position].per_primer_nombre)
        }
    }
